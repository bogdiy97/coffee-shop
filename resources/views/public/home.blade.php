...
<div class="relative h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 text-center text-white px-4">
        <h1 class="font-playfair text-5xl md:text-7xl font-bold mb-4 reveal">CAZYMY</h1>
        <p class="text-xl md:text-2xl mb-8 reveal">Experiența perfectă a cafelei artizanale alaturi de diferite evenimente deosebite</p>
    </div>
</div>
...
<div class="container mx-auto px-4 py-20">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white p-8 rounded-xl shadow-lg transform hover:-translate-y-1 transition-all reveal">
            ...
            <p class="text-gray-600 mb-6">Descoperă povestea și pasiunea din spatele CAZYMY</p>
            <a href="{{ route('about') }}"
               class="text-amber-900 hover:text-amber-700 font-medium inline-flex items-center">
